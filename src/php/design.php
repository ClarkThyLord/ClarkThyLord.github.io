...
$directory = scandir("../assets/design/");
...
foreach ($directory as $file){
    ...
    if ($file != "." && $file != ".."){
        ...
        $html .= '<div class="sub-sub-content selectable" style="text-align: center;" onclick="location.href = `'  . ('./assets/design/' . $file) . '`"><img class="image" src="' . ('./assets/design/' . $file) . '"><hr><span class="title">' . explode(".", $file)[0] . '</span></div>';
