<footer class="d-flex-md border-top bd-lightGray bg-dark">
	<div style="flex: 0.33;">
		...
		<div class="m-2 icon-box">
			...
			<ul>
				<li v-for="(time, skill) in {'Java': 2, 'PHP': 3, 'SQL': 3, 'Mongo': 3, 'Web Technologies': 5, 'JSON': 4, 'JavaScript': 3, 'Python 3': 3, 'API Development': 3, '2D': 6, '3D': 1, 'Game Development': 6, 'Chat Bots': 2, 'Image Processing': 2, 'AI': 3}" data-role="popover" data-hide-on-leave="true" data-popover-hide="0"
		...
		<div class="m-2">
			...
			<div>
				...
				<button onclick="window.location.href = 'https://discordapp.com/'" title="Discord" class="mt-2 image-button">
					<img src="./css/icons/discord.svg" class="icon" />
